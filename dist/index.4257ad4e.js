...
})({"21l9L":[function(require,module,exports) {
...
let barInterval = setInterval(()=>{
    ...
    if (c === 101) {
        ...
        (0, _gsapDefault.default).to(".loading__bar", {
            duration: 5,
            rotate: "90deg",
            left: "1000%"
        });
        (0, _gsapDefault.default).to(".loading__text, .loading__counter", {
            duration: 0.5,
            opacity: 0
        });
        (0, _gsapDefault.default).to(".loading__box", {
            duration: 1,
            height: "500px",
            borderRadius: "50%"
        });
        ...
        (0, _gsapDefault.default).to(".loading", {
            delay: 2,
            duration: 2,
            zIndex: 1,
...
(0, _dataJs.reviews).map((review)=>{
    let template = `<div class="swiper-slide"><div class="review"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M0 216C0 149.7 53.7 96 120 96h8c17.7 0 32 14.3 32 32s-14.3 32-32 32h-8c-30.9 0-56 25.1-56 56v8h64c35.3 0 64 28.7 64 64v64c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V320 288 216zm256 0c0-66.3 53.7-120 120-120h8c17.7 0 32 14.3 32 32s-14.3 32-32 32h-8c-30.9 0-56 25.1-56 56v8h64c35.3 0 64 28.7 64 64v64c0 35.3-28.7 64-64 64H320c-35.3 0-64-28.7-64-64V320 288 216z"/></svg><div class="review__card"><div class="review__topborder"></div><div class="review__text"><span>${review.review.substring(0, 1)}</span>${review.review.substring(1, review.review.length)}</div><img src="${review.image}" alt="" class="review__img"><div class="review__profile"><span>${review.name}</span><span>${review.position}</span></div></div></div></div>`;
...
questions.forEach((question)=>{
    question.addEventListener("click", ()=>{
        ...
        questions.filter((q)=>q !== question).forEach((q)=>q.classList.remove("open"));
    });
});

},{"gsap":"fPSuC","swiper":"cCbRx","./data.js":"6aExP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cCbRx":[function(require,module,exports) {
/**
 * Swiper 9.0.2
...
function updateProgress(translate) {
    ...
    if (params.loop) {
        const firstSlideIndex = (0, _utilsJs.elementIndex)(swiper.slides.filter((el)=>el.getAttribute("data-swiper-slide-index") === "0")[0]);
        const lastSlideIndex = (0, _utilsJs.elementIndex)(swiper.slides.filter((el)=>el.getAttribute("data-swiper-slide-index") * 1 === swiper.slides.length - 1)[0]);
...
},{"../../shared/utils.js":"dbikn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"28hyn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _utilsJs = require("../../shared/utils.js");
...
function slideToLoop(index = 0, speed = this.params.speed, runCallbacks = true, internal) {
    ...
    if (swiper.params.loop) {
        ...
        else newIndex = (0, _utilsJs.elementIndex)(swiper.slides.filter((slideEl)=>slideEl.getAttribute("data-swiper-slide-index") * 1 === newIndex)[0]);
    }
    return swiper.slideTo(newIndex, speed, runCallbacks, internal);
}
exports.default = slideToLoop;

},{"../../shared/utils.js":"dbikn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6QRzM":[function(require,module,exports) {
    ...
    if (params.loop) {
        ...
        if (params.centeredSlides) {
            if (slideToIndex < swiper.loopedSlides - slidesPerView / 2 || slideToIndex > swiper.slides.length - swiper.loopedSlides + slidesPerView / 2) {
                swiper.loopFix();
                slideToIndex = (0, _utilsJs.elementIndex)((0, _utilsJs.elementChildren)(slidesEl, `${slideSelector}[data-swiper-slide-index="${realIndex}"]`)[0]);
                (0, _utilsJs.nextTick)(()=>{
...
function loopFix({ slideRealIndex , slideTo =true , direction , setTranslate , activeSlideIndex , byController , byMousewheel  } = {}) {
    ...
    if (typeof activeSlideIndex === "undefined") activeSlideIndex = (0, _utilsJs.elementIndex)(swiper.slides.filter((el)=>el.classList.contains("swiper-slide-active"))[0]);
...
},{"../../shared/utils.js":"dbikn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"in4TF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function Virtual({ swiper , extendParams , on , emit  }) {
    ...
    function renderSlide(slide, index) {
        ...
        if (!params.renderSlide) slideEl.textContent = slide;
...
function Pagination({ swiper , extendParams , on , emit  }) {
    ...
    function onBulletClick(e) {
        const isBullet = e.target.matches((0, _classesToSelectorJsDefault.default)(swiper.params.pagination.bulletClass));
        if (!isBullet) return;
        e.preventDefault();
        const index = (0, _utilsJs.elementIndex)(e.target) * swiper.params.slidesPerGroup;
    ...
    function render() {
        ...
        el.forEach((subEl)=>{
            ...
            if (params.type === "bullets") swiper.pagination.bullets = [
                ...subEl.querySelectorAll((0, _classesToSelectorJsDefault.default)(params.bulletClass))
            ];
        });
...
function A11y({ swiper , extendParams , on  }) {
    ...
    function updatePagination() {
        ...
        swiper.pagination.bullets.forEach((bulletEl)=>{
            ...
            if (bulletEl.matches(`.${swiper.params.pagination.bulletActiveClass}`)) bulletEl.setAttribute("aria-current", "true");
    ...
    const scrollToSlide = (speed, value, runCallbacks)=>{
        if (value) for(let i = 0, length = swiper.slides.length; i < length; i += 1){
            ...
            if (slideHistory === value) {
                const index = (0, _utilsJs.elementIndex)(slide);
...
},{"ssr-window":"3lyfI","../../shared/utils.js":"dbikn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6TTnC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _ssrWindow = require("ssr-window");
var _utilsJs = require("../../shared/utils.js");
function HashNavigation({ swiper , extendParams , emit , on  }) {
    ...
    const onHashChange = ()=>{
        ...
        if (newHash !== activeSlideHash) {
            const newIndex = (0, _utilsJs.elementIndex)((0, _utilsJs.elementChildren)(swiper.slidesEl, `.${swiper.params.slideClass}[data-hash="${newHash}"], swiper-slide[data-hash="${newHash}"]`)[0]);
...
function Thumb({ swiper , extendParams , on  }) {
    ...
    function update(initial) {
        ...
        else for(let i = 0; i < thumbsToActivate; i += 1)thumbsSwiper.slides[swiper.realIndex + i].classList.add(thumbActiveClass);
...
function effectVirtualTransitionEnd({ swiper , duration , transformElements , allSlides  }) {
    ...
    if (swiper.params.virtualTranslate && duration !== 0) {
        ...
        if (allSlides) transitionEndTarget = transformElements;
            ...
            return (0, _utilsJs.elementIndex)(el) === activeIndex;
        });
...
},{"../../shared/create-shadow.js":"9JYAP","../../shared/effect-init.js":"5DnvG","../../shared/effect-target.js":"eKqS8","../../shared/effect-virtual-transition-end.js":"VhYFx","../../shared/utils.js":"dbikn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6aExP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
let reviews = [
    {
        ...
        position: "Udemy student",
        image: (0, _imagesDefault.default).avatar1,
    ...
    },
    {
        name: "Waleed Alkathiri",
        position: "Udemy student",
        image: (0, _imagesDefault.default).avatar2,
        review: "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Qui, maxime. Amet, unde laudantium dolore praesentium, asperiores sunt voluptas illo laborum quod laboriosam facere dolor distinctio tempora adipisci beatae reiciendis itaque!"
    },
    {
        name: "Waleed Alkathiri",
        position: "Udemy student",
        image: (0, _imagesDefault.default).avatar3,
        review: "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Qui, maxime. Amet, unde laudantium dolore praesentium, asperiores sunt voluptas illo laborum quod laboriosam facere dolor distinctio tempora adipisci beatae reiciendis itaque!"
    },
    {
        name: "Waleed Alkathiri",
        position: "Udemy student",
        image: (0, _imagesDefault.default).avatar4,
        review: "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Qui, maxime. Amet, unde laudantium dolore praesentium, asperiores sunt voluptas illo laborum quod laboriosam facere dolor distinctio tempora adipisci beatae reiciendis itaque!"
    },
    {
        name: "Waleed Alkathiri",
        position: "Udemy student",
        image: (0, _imagesDefault.default).avatar5,
        review: "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Qui, maxime. Amet, unde laudantium dolore praesentium, asperiores sunt voluptas illo laborum quod laboriosam facere dolor distinctio tempora adipisci beatae reiciendis itaque!"
    },
    {
        name: "Waleed Alkathiri",
        position: "Udemy student",
        image: (0, _imagesDefault.default).avatar6,
        review: "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Qui, maxime. Amet, unde laudantium dolore praesentium, asperiores sunt voluptas illo laborum quod laboriosam facere dolor distinctio tempora adipisci beatae reiciendis itaque!"
    },
    {
        name: "Waleed Alkathiri",
        position: "Udemy student",
        image: (0, _imagesDefault.default).avatar7,
        review: "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Qui, maxime. Amet, unde laudantium dolore praesentium, asperiores sunt voluptas illo laborum quod laboriosam facere dolor distinctio tempora adipisci beatae reiciendis itaque!"
    }
];

},{"./images":"hkI8A","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hkI8A":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _1Png = require("../images/avatars/1.png");
var _1PngDefault = parcelHelpers.interopDefault(_1Png);
var _2Png = require("../images/avatars/2.png");
var _2PngDefault = parcelHelpers.interopDefault(_2Png);
var _3Png = require("../images/avatars/3.png");
var _3PngDefault = parcelHelpers.interopDefault(_3Png);
var _4Png = require("../images/avatars/4.png");
var _4PngDefault = parcelHelpers.interopDefault(_4Png);
var _5Png = require("../images/avatars/5.png");
var _5PngDefault = parcelHelpers.interopDefault(_5Png);
var _6Png = require("../images/avatars/6.png");
var _6PngDefault = parcelHelpers.interopDefault(_6Png);
var _7Png = require("../images/avatars/7.png");
var _7PngDefault = parcelHelpers.interopDefault(_7Png);
var _19Jpg = require("../images/shapes/19.jpg");
var _19JpgDefault = parcelHelpers.interopDefault(_19Jpg);
var _24Jpg = require("../images/shapes/24.jpg");
var _24JpgDefault = parcelHelpers.interopDefault(_24Jpg);
var _26Jpg = require("../images/shapes/26.jpg");
var _26JpgDefault = parcelHelpers.interopDefault(_26Jpg);
var _44Jpg = require("../images/shapes/44.jpg");
var _44JpgDefault = parcelHelpers.interopDefault(_44Jpg);
var _213Png = require("../images/shapes/213.png");
...
const images = [
    ...
    (0, _19JpgDefault.default),
    (0, _24JpgDefault.default),
    (0, _26JpgDefault.default),
    (0, _44JpgDefault.default),
    (0, _213PngDefault.default)
];
exports.default = images;

},{"../images/avatars/1.png":"872UZ","../images/avatars/2.png":"6IbcM","../images/avatars/3.png":"2Iwn8","../images/avatars/4.png":"fo0Ym","../images/avatars/5.png":"kxBZb","../images/avatars/6.png":"aJaZr","../images/avatars/7.png":"e2gld","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../images/shapes/19.jpg":"2g7hp","../images/shapes/24.jpg":"b2JBl","../images/shapes/26.jpg":"kDpvo","../images/shapes/44.jpg":"aVnKJ","../images/shapes/213.png":"iKr4G"}],"872UZ":[function(require,module,exports) {
module.exports = require("ee26e55fad249c19").getBundleURL("dwy8B") + "1.2cdddb2a.png" + "?" + Date.now();

},{"ee26e55fad249c19":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"6IbcM":[function(require,module,exports) {
module.exports = require("fdbd6d126b287efb").getBundleURL("dwy8B") + "2.82020d7a.png" + "?" + Date.now();

},{"fdbd6d126b287efb":"lgJ39"}],"2Iwn8":[function(require,module,exports) {
module.exports = require("2a0b106497797b3b").getBundleURL("dwy8B") + "3.034a4cca.png" + "?" + Date.now();

},{"2a0b106497797b3b":"lgJ39"}],"fo0Ym":[function(require,module,exports) {
module.exports = require("52a6ba8c5dbbaec3").getBundleURL("dwy8B") + "4.18e30ef1.png" + "?" + Date.now();

},{"52a6ba8c5dbbaec3":"lgJ39"}],"kxBZb":[function(require,module,exports) {
module.exports = require("636b8a3a5612a150").getBundleURL("dwy8B") + "5.d945018a.png" + "?" + Date.now();

},{"636b8a3a5612a150":"lgJ39"}],"aJaZr":[function(require,module,exports) {
module.exports = require("5125c9392ff337d9").getBundleURL("dwy8B") + "6.59871cda.png" + "?" + Date.now();

},{"5125c9392ff337d9":"lgJ39"}],"e2gld":[function(require,module,exports) {
module.exports = require("2025841ddc1bced1").getBundleURL("dwy8B") + "7.76a1d06e.png" + "?" + Date.now();

},{"2025841ddc1bced1":"lgJ39"}],"2g7hp":[function(require,module,exports) {
module.exports = require("1839bbd393c7ffaf").getBundleURL("dwy8B") + "19.522bcde0.jpg" + "?" + Date.now();

},{"1839bbd393c7ffaf":"lgJ39"}],"b2JBl":[function(require,module,exports) {
module.exports = require("19da751b41dcd851").getBundleURL("dwy8B") + "24.7aaf3bcd.jpg" + "?" + Date.now();

},{"19da751b41dcd851":"lgJ39"}],"kDpvo":[function(require,module,exports) {
module.exports = require("7bf96db1825f32bf").getBundleURL("dwy8B") + "26.f7846de6.jpg" + "?" + Date.now();

},{"7bf96db1825f32bf":"lgJ39"}],"aVnKJ":[function(require,module,exports) {
module.exports = require("c78d92ef3d131ac7").getBundleURL("dwy8B") + "44.cc94e6bf.jpg" + "?" + Date.now();

},{"c78d92ef3d131ac7":"lgJ39"}],"iKr4G":[function(require,module,exports) {
module.exports = require("8ea4fbf3deab2889").getBundleURL("dwy8B") + "213.8fc10fba.png" + "?" + Date.now();

},{"8ea4fbf3deab2889":"lgJ39"}]},["21l9L","9OMkf"], "9OMkf", "parcelRequireba11")
